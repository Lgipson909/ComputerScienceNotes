...
PS C:\Users\gipso> get-commands
get-commands : The term 'get-commands' is not recognized as the name of a cmdlet, function, script file, or operable program. Check the spelling of the
name, or if a path was included, verify that the path is correct and try again.
At line:1 char:1
+ get-commands
+ ~~~~~~~~~~~~
    + CategoryInfo          : ObjectNotFound: (get-commands:String) [], CommandNotFoundException
    + FullyQualifiedErrorId : CommandNotFoundException

PS C:\Users\gipso> get-command
